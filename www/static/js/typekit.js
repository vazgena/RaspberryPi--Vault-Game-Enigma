...
window.Typekit.config = {
    "a": "392524",
    "c": [".tk-ff-meta-web-pro", "\"ff-meta-web-pro\",sans-serif", ".tk-cooper-black-std", "\"cooper-black-std\",sans-serif", ".tk-franklin-gothic-ext-comp-urw", "\"franklin-gothic-ext-comp-urw\",sans-serif"],
    "fi": [4650, 6840, 10419],
    "fc": [{
        "id": 4650,
        "family": "ff-meta-web-pro",
        "src": "https://use.typekit.net/af/829fc9/00000000000000003b9b06da/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
        ...
        "src": "https://use.typekit.net/af/4e1b68/000000000000000000013101/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 10419,
        "family": "franklin-gothic-ext-comp-urw",
        "src": "https://use.typekit.net/af/8d9b32/0000000000000000000118bf/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
    ...
    "fn": ["cooper-black-std", ["n4"], "ff-meta-web-pro", ["n4"], "franklin-gothic-ext-comp-urw", ["n4"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.19.2",
    "kt": "fbl0lhq",
...
/*{"k":"1.19.2","auto_updating":true,"last_published":"2017-09-05 04:13:03 UTC"}*/
;
